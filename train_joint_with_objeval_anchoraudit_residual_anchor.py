...
from src.dataset_joint_with_part_anchoraudit_residual_anchor import DinoClipJointDataset
from src.train_util_joint_with_objeval_anchoraudit_residual_anchor import do_train_joint
