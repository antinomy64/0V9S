...
from src.dataset_joint_with_part_anchoraudit_global import DinoClipJointDataset
from src.train_util_joint_with_objeval_anchoraudit_global import do_train_joint
...
if __name__ == '__main__':
    ...
    parser.add_argument('--part_feature_name', type=str, default='patch_tokens', help='Patch token field for part branch')
    ...
    # mIoU evaluation args: keep the evaluation path SAME as the user-provided main.py flow
